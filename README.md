...
<table align="center">
  <tr>
    <td width="1440">
      ...
      <body>
        <strong>This project is a Business Case Simulation focused on the performance analysis of a global e-commerce company. While the business scenario is fictional, the analysis is conducted using a real world dataset</strong> The data represents a US-based e-commerce retailer specializing in consumer electronics and accessories, serving a global customer base. Founded in 2018, the company has experienced rapid growth in recent years, alongside intensifying competition and the operational challenges and opportunities introduced by the COVID-19 pandemic. <br>
        <br>The company’s customer base has grown to nearly 88,000 customers, supported by over 108,000 transactions, generating more than $28 million in total revenue. The dataset spans multiple business dimensions, including sales performance, product categories, regional sales distribution, and customer loyalty program participation. <br>
        <br>In this scenario, the analysis is conducted on behalf of the Head of Operations, with the objective of evaluating company performance over a four-year period (2019–2022). This comprehensive review provides valuable insights that internal cross-functional teams will use to streamline processes and enhance the company’s commercial performance. The key insights and recommendations focus on the following areas:
      </body>
    ...
    <td>
      ...
      <ol>
        ...
        <li>Post-Pandemic Sales Normalization (2020-2022 Trends) <ul>
            <li>2020 Sales Surge: The pandemic led to a significant boost in e-commerce sales, with Q2-Q4 2020 seeing a rapid increase (e.g., <strong>Q4 2020 was nearly double Q4 2019</strong>). </li>
        ...
        <li>Declining Growth Throughout 2022 – Indicating Weak Consumer Demand <ul>
            ...
            <li>Q4: <strong>Historic low, indicating critical demand issues</strong>. This suggests customer retention, pricing, or product-market fit issues. The company may need to re-strategize through marketing, promotions, or change in pricing. </li>
          </ul>
        </li>
      </ol>
      ...
      <tr>
        <td>
          <ul>
            ...
            <li>Loyalty members outspend non-loyalty members on returning orders by nearly $60, whereas non-loyalty members have historically spent more on their first orders.</li>
          </ul>
        </td>
      </tr>
    </table>
  ...
  <tr>
    ...
    <td valign="top" width="500">
      <ul>
        ...
        <li>Coincidentally, these two items have the highest AOV and are company's most expensive products.</li>
...
<table align="center">
  ...
  <tr valign="top">
     <td width="900">
      <ul>
        <li>The North American region contributes the most to sales revenue for each product.</li>
          <ul>
            <li>An average of 52% of total sales per product.</li>
            <li>$2.7 million in 2022.</li>
          </ul>
        <li>In contrast, the company's sales have underperformed in the Latin American region.</li>
          <ul>
...
<table align="center">
    ...
    <h4>Based on the uncovered insights, here are actionable items that the company can take away from the analysis.</h4>
      <ul>
        ...
        <ul>
          <li>The average sales growth year-over-year for January is <strong>-12%</strong>, and for February, it is <strong>-23%</strong>.</li>
          <li>Average Sales Growth for Q4 post-pandemic is <strong>-17%</strong>.</li>
        </ul>
        ...
        <ul>
          <li>The average year-over-year sales growth post-pandemic is <strong>-28%</strong>.</li>
          <li>The average year-over-year order count growth post-pandemic is <strong>-17%</strong>.</li>
        </ul>
        <h3>Products</h3>
        <li>Optimize inventory for high-performing products year-round.</li>
        <ul>
          <li>The 27-Inch 4K Gaming Monitor is the strongest product in terms of sales, approaching <strong>$10 million</strong> over four years.</li>
          <li>The Apple AirPods are also a strong-selling product, with close to <strong>$8 million</strong> in sales over four years.</li>
        </ul>
        <li>Deprioritize inventory for low-performing products.</li>
        <ul>
          <li>Bose SoundSport Headphones and Apple iPhone constitute for nearly <strong>0%</strong> of total purchase orders.</li>
        </ul>
        <li>Investigate sales for MacBook Air laptops.</li>
        <ul>
          <li>MacBook Air Laptops rank third in sales revenue (<strong>22%</strong>) but fall in the bottom half for number of purchase orders (<strong>3.67%</strong>).</li>
        </ul>
        ...
        <ul>
          <li>Loyalty Member AOV grew <strong>18%</strong> from 2019 to 2022.</li>
          <li>Loyalty members spent <strong>$31</strong> more on average than non-loyalty members in 2022.</li>
        </ul>
        <li>Offer incentives for loyalty members to target purchases of MacBook Air laptops.</li>
        <ul>
          <li>Loyalty members align with the ideal user persona for MacBook Air laptops, as they purchase high-priced products, are more likely to return as customers, and rarely make returns.</li>
        </ul>
        <h3>Refund Rates</h3>
        <li>Streamline product quality control for high AOV products as they are the most frequently returned products.</li>
        <ul>
          <li>Macbook Air Laptops had an average return rate of <strong>14%</strong> from 2019 to 2021.</li>
          <li>Thinkpad Laptops also had an average return rate of <strong>14%</strong> from 2019 to 2021.</li>
        </ul>
        <h3>Regions</h3>
        <li>Maximize market share in North America, as this region dominates sales across all products.</li>
        <ul>
          <li><strong>52%</strong> of product sales were in the North American region.</li>
        </ul>
        ...
        <ul>
          <li>Only <strong>6%</strong> of product sales were in the Latin American region.</li>
        </ul>
      </ul>
    </td>
  </tr>
